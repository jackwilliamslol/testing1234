...
<html lang="en">
	...
	<body class="container col-md-10 offset-md-1 col-lg-8 offset-lg-2">
		...
		<a href='GLITForm_testing_JN.htm<% response.write(querystring) %>' class="btn btn-block btn-lg btn-primary" type="button">Back To Form</a>
	...
	<div id="timeStamp2" style="padding: 40px;text-align: center;">
		...
		<!--webbot bot="Timestamp" S-Type="EDITED" S-Format="%d/%m/%Y %I:%M:%S %p" startspan -->03/02/2021 03:42:42 PM<!--webbot bot="Timestamp" i-checksum="29792" endspan -->
		<br>
		<!--webbot bot="HitCounter" i-image="4" I-ResetValue="0" I-Digits="0" U-Custom startspan --><img src="../../../../_vti_bin/fpcount.exe/?Page=process_improvement/Blue%20Prism/glit_form/prod/GLITForm_finished_testing_JN.asp|Image=4" alt="Hit Counter"><!--webbot bot="HitCounter" i-checksum="6702" endspan -->
