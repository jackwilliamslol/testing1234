<% 
    ...
    mailBody = mailBody & vbCrLf & "email_parcelCrossTheThreshold:" & vbCrLf & Request.Form("parcelCrossTheThresholdQuesitonRadios") & vbCrLf
    mailBody = mailBody & vbCrLf & "email_photoExists:" & vbCrLf & Request.Form("photoExistsQuesitonRadios") & vbCrLf
    mailBody = mailBody & vbCrLf & "email_photoCompliant:" & vbCrLf & Request.Form("photoCompliantQuesitonRadios") & vbCrLf
    mailBody = mailBody & vbCrLf & "email_signatureCaptured:" & vbCrLf & Request.Form("signatureCapturedQuesitonRadios") & vbCrLf
    ...
    Sub reportBack(msg, isError, userID)
        ...
        If isError = true Then
            destination = "GLITForm_finished_testing_JN.asp?msg=" & msg & "&alertType=danger"
        Else
            destination = "GLITForm_finished_testing_JN.asp?msg=" & msg & "&alertType=success"
        End If
