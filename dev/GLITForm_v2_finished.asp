...
<html lang="en">
	...
	<body class="container col-md-10 offset-md-1 col-lg-8 offset-lg-2">
		...
		<a href='GLITForm_v2.htm<% response.write(querystring) %>' class="btn btn-block btn-lg btn-primary" type="button">Back To Form</a>
	...
	<div id="timeStamp2" style="padding: 40px;text-align: center;">
		...
		<!--webbot bot="Timestamp" S-Type="EDITED" S-Format="%d/%m/%Y %I:%M:%S %p" startspan -->26/02/2021 12:04:35 PM<!--webbot bot="Timestamp" i-checksum="29802" endspan -->
		<br>
		<!--webbot bot="HitCounter" i-image="4" I-ResetValue="0" I-Digits="0" U-Custom startspan --><img src="../../../../_vti_bin/fpcount.exe/?Page=process_improvement/Blue%20Prism/glit_form/prod/GLITForm_v2_finished.asp|Image=4" alt="Hit Counter"><!--webbot bot="HitCounter" i-checksum="44508" endspan -->
